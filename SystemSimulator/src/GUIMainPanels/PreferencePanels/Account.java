  ...
  private class ChangeListener implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
          if (e.getSource() == checks.get(0)) {
              ...
              m.getPrefs().put("username", m.getMainWindow().getProgramWindowPanel().getPanel_2()
                               .getPanel_1().getPanel_3().getPanel_1().getUsername());
              
          } else if (e.getSource() == checks.get(1)) {
              m.getPrefs().putBoolean("rememberPassword",
                                      checks.get(1).isSelected());
            m.getPrefs().put("password", m.getMainWindow().getProgramWindowPanel().getPanel_2()
                             .getPanel_1().getPanel_3().getPanel_1().getPassword());
          }
      }
  }
